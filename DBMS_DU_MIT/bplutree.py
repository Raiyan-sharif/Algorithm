...
def demo_bplustree():
    ...
    print('\nB+ tree with 1 item...')
    bplustree.insert('apple', 'আপেল')
    bplustree.show()

    print('\nB+ tree with 2 items...')
    bplustree.insert('Android', 'অ্যান্ড্রয়েড')
    bplustree.show()

    print('\nB+ tree with 3 items...')
    bplustree.insert('Hill', 'পাহাড়')
    bplustree.show()

    print('\nB+ tree with 4 items...')
    bplustree.insert('Plane', 'সমতল')
    bplustree.show()

    print('\nB+ tree with 5 items...')
    bplustree.insert('Pen', 'কলম')
    bplustree.show()

    print('\nB+ tree with 6 items...')
    bplustree.insert('professor', 'অধ্যাপক')
    bplustree.show()

    print('\nRetrieving values with key e...')
    print(bplustree.retrieve('Pen'))
